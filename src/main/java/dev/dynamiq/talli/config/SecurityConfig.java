    ...
    SecurityFilterChain filterChain(HttpSecurity http, PersistentTokenRepository persistentTokenRepository) throws Exception {
        http
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/invoices", "/invoices/generate", "/invoices/generate-fixed", "/invoices/generate-deposit", "/invoices/*/void", "/invoices/*/write-off", "/invoices/*/write-off/restore", "/invoices/*/delete", "/invoices/*/notes", "/invoices/*/pdf", "/invoices/*/attachments", "/invoices/*/mercury-link").hasAuthority("manage-invoices")
